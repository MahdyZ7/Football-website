        ...
        <div className="summary-card">
          ...
          <div className="summary-grid">
            <div className="summary-item">
              <h4 className="text-team1">🟦 {team1.name}</h4>
            ...
            <div className="summary-item">
              <h4 className="text-team2">🟩 {team2.name}</h4>
            ...
            {teamMode === 3 && (
              <div className="summary-item">
                <h4 className="text-team3">🟨 {team3.name}</h4>
            ...
            <div className="summary-item">
              <h4 className="text-muted">📋 Available</h4>
              <p>{availablePlayers.length} players</p>
            </div>
            {waitingListPlayers.length > 0 && (
              <div className="summary-item">
                <h4 className="text-muted">⏳ Waiting</h4>
                <p>{waitingListPlayers.length} players</p>
              </div>
            )}
            {removedPlayers.length > 0 && (
              <div className="summary-item">
                <h4 className="text-accent">🗑️ Removed</h4>
